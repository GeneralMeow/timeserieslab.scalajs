...
/** @constructor */
function $c_Lsandbox_Main$() {
  $c_O.call(this)
}
$c_Lsandbox_Main$.prototype = new $h_O();
$c_Lsandbox_Main$.prototype.constructor = $c_Lsandbox_Main$;
/** @constructor */
function $h_Lsandbox_Main$() {
  /*<skip>*/
}
$h_Lsandbox_Main$.prototype = $c_Lsandbox_Main$.prototype;
$c_Lsandbox_Main$.prototype.init___ = (function() {
  return this
});
$c_Lsandbox_Main$.prototype.main__V = (function() {
...
$c_Lsandbox_Main$.prototype.csvUploaded__T__V = (function(text) {
  var replaceData = $g.replaceData;
  var xs = $m_sjsr_RuntimeString$().split__T__T__I__AT(text, "\n", 0);
  if ((xs.u.length === 0)) {
    if ((xs.u.length === 0)) {
    ...
    if ((size > 0)) {
      $m_s_Array$().copy__O__I__O__I__I__V(xs, 1, result, 0, size)
    };
    var jsx$1 = result
  } else {
    var until$1 = xs.u.length;
    ...
    if ((size$1 > 0)) {
      $m_s_Array$().copy__O__I__O__I__I__V(xs, 1, result$1, 0, size$1)
    };
    var jsx$1 = result$1
  };
  var xs$1 = $asArrayOf_O(jsx$1, 1);
  var elems$2 = null;
  elems$2 = [];
  ...
  var i = 0;
  var len = xs$1.u.length;
  while ((i < len)) {
    var index = i;
    var arg1 = xs$1.get(index);
    var line = $as_T(arg1);
    var tokens = $m_sjsr_RuntimeString$().split__T__T__I__AT(line, ",", 0);
    var jsx$3 = tokens.get(0);
    var x$4 = tokens.get(1);
    var this$35 = new $c_sci_StringOps().init___T(x$4);
    var jsx$2 = $m_jl_Double$();
    var $$this = this$35.repr$1;
    var elem = new $c_T2().init___O__O(jsx$3, jsx$2.parseDouble__T__D($$this));
    elems$2.push(elem);
    i = ((1 + i) | 0)
  };
  var data = $makeNativeArrayWrapper($d_T2.getArrayOf(), elems$2);
  var len$1 = data.u.length;
  var a1 = $newArrayObject($d_T.getArrayOf(), [len$1]);
  var len$2 = data.u.length;
  var a2 = $newArrayObject($d_D.getArrayOf(), [len$2]);
  var i$1 = 0;
  while ((i$1 < data.u.length)) {
    var index$1 = i$1;
    var e = data.get(index$1);
    a1.set(i$1, $as_T2(e).$$und1$f);
    a2.set(i$1, $uD($as_T2(e).$$und2$f));
    i$1 = ((1 + i$1) | 0)
  };
  var $$this$1 = $m_s_Predef$().genericArrayOps__O__scm_ArrayOps(a1);
  if ($is_sjs_js_ArrayOps($$this$1)) {
    var x2 = $as_sjs_js_ArrayOps($$this$1);
    var jsx$5 = x2.scala$scalajs$js$ArrayOps$$array$f
  } else if ($is_sjs_js_WrappedArray($$this$1)) {
    var x3 = $as_sjs_js_WrappedArray($$this$1);
    var jsx$5 = x3.array$6
  } else {
    var result$2 = [];
    var i$2 = 0;
    var len$3 = $$this$1.length__I();
    while ((i$2 < len$3)) {
      var arg1$1 = $$this$1.apply__I__O(i$2);
      $uI(result$2.push(arg1$1));
      i$2 = ((1 + i$2) | 0)
    };
    var jsx$5 = result$2
  };
  var $$this$2 = $m_s_Predef$().genericArrayOps__O__scm_ArrayOps(a2);
  if ($is_sjs_js_ArrayOps($$this$2)) {
    var x2$1 = $as_sjs_js_ArrayOps($$this$2);
    var jsx$4 = x2$1.scala$scalajs$js$ArrayOps$$array$f
  } else if ($is_sjs_js_WrappedArray($$this$2)) {
    var x3$1 = $as_sjs_js_WrappedArray($$this$2);
    var jsx$4 = x3$1.array$6
  } else {
    var result$3 = [];
    var i$3 = 0;
    var len$4 = $$this$2.length__I();
    while ((i$3 < len$4)) {
      var arg1$2 = $$this$2.apply__I__O(i$3);
      $uI(result$3.push(arg1$2));
      i$3 = ((1 + i$3) | 0)
    };
    var jsx$4 = result$3
  };
  replaceData(jsx$5, jsx$4)
});
$c_Lsandbox_Main$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lsandbox_Main$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lsandbox_Main$ = new $TypeData().initClass({
  Lsandbox_Main$: 0
}, false, "sandbox.Main$", {
  Lsandbox_Main$: 1,
  O: 1,
...
$c_Lsandbox_Main$.prototype.$classData = $d_Lsandbox_Main$;
var $n_Lsandbox_Main$ = (void 0);
function $m_Lsandbox_Main$() {
  if ((!$n_Lsandbox_Main$)) {
    $n_Lsandbox_Main$ = new $c_Lsandbox_Main$().init___()
  };
  return $n_Lsandbox_Main$
}
/** @constructor */
...
$e.sandbox = ($e.sandbox || {});
$e.sandbox.Main = $m_Lsandbox_Main$;
$e.csvUploaded = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  $m_Lsandbox_Main$().csvUploaded__T__V(prep0)
});
$m_Lsandbox_Main$().main__V();
}).call(this);
//# sourceMappingURL=timeserieslab-fastopt.js.map
